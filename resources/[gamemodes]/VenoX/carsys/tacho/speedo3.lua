...
function drawNeedle()
	...
	if veh then
		...
		if hour >= 20 or hour <= 8 then
			...
			dxDrawImage ( g_screenWidth - g_ImageW - g_XOffset,	g_screenHeight - g_ImageH - g_YOffset, g_ImageW, g_ImageH, "images/speedcircle.png", 0, 0, 0, tocolor ( 255, 255, 255, alpha ), true )
		...
		lh = (g_screenHeight - g_ImageH - g_YOffset) + 181
		...
		if lights then
			...
			if lights == 2 then
				...
				dxDrawImage( g_screenWidth - g_ImageW - g_XOffset + 52 / 2 / 2 + 50 + 85, g_screenHeight - g_ImageH + 89 + 10 / 2, 52/2, 39/2, "images/lights.png", 0, 0, 0, white, true)
		...
		if getVehicleEngineState ( veh ) then
			...
			dxDrawImage ( math.floor ( g_screenWidth - g_ImageW - g_XOffset - 52 / 2 / 2 + 39 + 85 ), math.floor ( g_screenHeight - g_ImageH + 89 + 10 / 2 ), math.floor ( 52/2 ), math.floor ( 39/2 ), "images/Carsys/Battery.png", 0, 0, 0, white, true )
	...
	--[[	dxDrawImage(l1x-3, lh-3, l6x+3-(l1x-3)+lhz, lwz+6, "images/numbbers/empty.bmp", 0, 0, 0, white, true)

		dxDrawImage(l1x, lh, lhz, lwz, "images/numbbers/"..NR1..".bmp", 0, 0, 0, white, true)

		dxDrawImage(l2x, lh, lhz, lwz, "images/numbbers/"..NR2..".bmp", 0, 0, 0, white, true)

		dxDrawImage(l3x, lh, lhz, lwz, "images/numbbers/"..NR3..".bmp", 0, 0, 0, white, true)

		dxDrawImage(l4x, lh, lhz, lwz, "images/numbbers/"..NR4..".bmp", 0, 0, 0, white, true)

		dxDrawImage(l5x, lh, lhz, lwz, "images/numbbers/"..NR5..".bmp", 0, 0, 0, white, true)

		dxDrawImage(l6x, lh, lhz, lwz, "images/numbbers/"..NR6..".bmp", 0, 0, 0, white, true)

		dxDrawImage(l6x-3, lh+lwz-1, 4, 4, "images/redddot.png", 0, 0, 0, white, true) --]]
		...
		if vehFuel and nh and nw and n2h and n2w then
			...
			vehFuel = vehFuel*1.85
                        ...
                        local vehTextFuel = math.ceil(vehFuel/1.85)

                        if vehFuel/1.85 < 0 then
                        ...
                        if vehTextFuel > 75 then
                            
                            tank = 1

                        elseif vehTextFuel > 50 then
                            
                            tank = 2

                        elseif vehTextFuel > 25 then

                            tank = 3

                        elseif vehTextFuel > 0 then
                        ...
                        dxDrawImage(l1x+99, lh-48, 36, 21, "images/fuelarrow.png", 0, 0, 0, white, true)
		...
		if drehzahl then
                        ...
                        local drehzahlText = math.floor(drehzahl*8000)
                        ...
                        lh = (g_screenHeight - g_ImageH - g_YOffset) + 157

                        

                        d1 = math.floor(drehzahlText/1000)

                        d2 = math.floor(drehzahlText/100)-d1*10

                        d3 = math.floor(drehzahlText/10)-d1*100-d2*10

                        d4 = math.floor(drehzahlText)-d1*1000-d2*100-d3*10

                        dxDrawImage(l1x, lh, 13, 18, "images/tachoziffern/"..d1..".png", 0, 0, 0, white, true)

                        dxDrawImage(l2x, lh, 13, 18, "images/tachoziffern/"..d2..".png", 0, 0, 0, white, true)

                        dxDrawImage(l3x, lh, 13, 18, "images/tachoziffern/"..d3..".png", 0, 0, 0, white, true)

                        dxDrawImage(l4x, lh, 13, 18, "images/tachoziffern/"..d4..".png", 0, 0, 0, white, true)
		...
		dxDrawImage(needlX, needlY, g_ImageW, g_ImageH, "images/speedarrow.png", vehSpeed*0.805-3, 0, 0, white, true)
...
function initGui(full)
    ...
    disc = guiCreateStaticImage(g_screenWidth - g_ImageW - g_XOffset, g_screenHeight - g_ImageH - g_YOffset, g_ImageW, g_ImageH, "images/speedcircle"..full..".png", false)
