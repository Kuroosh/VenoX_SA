mechanikerVehicless = {}
mechanikerVehicless[1] = createFactionVehicle(525, -2392.79, -153.79, 35.29, 0, 0, 269.49, 11, 255, 255, 255, 0)
mechanikerVehicless[2] = createFactionVehicle(525, -2392.79, -148.09, 35.29, 0, 0, 269.49, 11, 255, 255, 255, 0)
mechanikerVehicless[3] = createFactionVehicle(525, -2392.70, -142.40, 35.29, 0, 0, 269.49, 11, 255, 255, 255, 0)

for k, v in pairs(mechanikerVehicless) do
...
addEventHandler("onMarkerHit", abgabeMarker, function(vehicle)
    if getElementType(vehicle) == "vehicle" then
        ...
        if player and isMechaniker(player) then
            for i = 1, #mechanikerVehicless do
                if mechanikerVehicless[i] == vehicle then
