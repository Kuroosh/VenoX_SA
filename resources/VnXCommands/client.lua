local allCommands = {
	...
	["fahrzeug"] = {    "/eject [Name/all] - Schmeißt jemanden/alle aus dem Auto",
	...
	["polizei"] = { 	"/stellen - Stellen mit Wanteds am PD",
						"/jailtime - Zeigt die verbleibende Knastzeit an",
						"/bail - Bezahlt die Kaution falls vorhanden",
						"/staatstest - Nimmt den Drogentest vom Polizisten an",
	...
	["mats"] = {        "/gunhelp - Zeigt Matspreise der Waffen an",
						"/sellgun [Name] [Waffe] [Ammo] - Verkauft eine Waffen an jemanden" },
						
	["handy"] = {   	"/sms [Nummer] [Text] - Schreibt einer Nummer einen Text",
	...
	["chat"] = {		"/meCMD [Text] - Benutzt einen blauen Chat",
						"/s [Text] - Schreit",
						"/l [Text] - Flüstert" },
...
local allAdminCommands = {
	[1] = { "/achat [Text] - Benutzt den VIP Chat (nur für VIP)",
	...
	[2] = { "/tickets - Öffnet das Ticket-Fenster",
			...
			"/achat [Text] - Benutzt den privaten Adminchat" },
	[3] = { "/aduty - Geht Adminduty",
			...
			"/timeban [Name] [Zeit] [Grund] - Bannt jemanden für eine Zeit",
	...
	[4] = { "/newhouse [Preis] [Interior] - Erstellt einen Interior",
			"/adminint [Interior] - Portet in einen Interior ( 1 - 17 )  (2,16,12,17 nicht nutzen ) ",
			...
			"/permaban [Name] [Grund] - Bannt jemanden Permanent" },
	[5] = { "/aweather - Ändert das Wetter",
            ...
            "/aus_global - Globalchat Ausschalten" ,
            "/an_global - Globalchat Anschalten" },
	[7] = { "/settestgeld [Anzahl] - Settet Testgeld", 
	...
	if rang then
		...
		if rang and rang >= 1 and rang <= 6 then
			...
			for i=1, #allAdminCommands[rang] do
				outputChatBox ( allAdminCommands[rang][i], 0, 105, 145 )
				wasthere = true
			end
		else
