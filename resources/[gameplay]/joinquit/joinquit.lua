...
addEventHandler('onClientPlayerJoin', root,
	function()
		...
		if showColorCodes then
			...
			outputChatBox('#FFFFFF * ' .. getPlayerName(source) .. ' hat #00C8FFVenox #FFFFFFReallife #00C800Betreten.', 255, 100, 100, true)
		else
...
addEventHandler('onClientPlayerQuit', root,
	function(reason)
		...
		if showColorCodes then
			outputChatBox('#FFFFFF * ' .. getPlayerName(source) .. ' hat #00C8FFVenox #FFFFFFReallife #C80000Verlassen.', 255, 100, 100, true)
