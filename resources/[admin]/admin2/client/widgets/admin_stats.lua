...
function aPlayerStats(player)
    if (aStatsForm == nil) then
        ...
        while weapon <= 11 do
            ...
            aStatsGUI[stat] = {}
            local label =
                guiCreateLabel(0.05, 0.06 + 0.07 * weapon, 0.20, 0.07, weapons[weapon] .. ":", true, aStatsForm)
            ...
            aStatsGUI[stat]["button"] =
                guiCreateButton(0.37, 0.05 + 0.07 * weapon, 0.10, 0.06, "Set", true, aStatsForm, "setstat")
            weapon = weapon + 1
        end
        ...
        while body <= 4 do
            ...
            guiEditSetMaxLength(aStatsGUI[stat]["value"], 4)
            aStatsGUI[stat]["button"] =
                guiCreateButton(0.82, 0.05 + 0.07 * body, 0.10, 0.06, "Set", true, aStatsForm, "setstat")
            body = body + 1
        end
