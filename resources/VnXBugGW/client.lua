function TXDFile() 
theTXD = engineLoadTXD("burrito.txd") -- Die TXD Datei 
engineImportTXD(theTXD, 482) -- Wird ersetzt 
end 
addEventHandler("onClientResourceStart", getResourceRootElement(), TXDFile) 
function DFFFile() 
theDFF = engineLoadDFF("burrito.dff") -- Die DFF Datei 
engineReplaceModel(theDFF, 482) -- Wird ersetzt 
end 
addEventHandler("onClientResourceStart", getResourceRootElement(), DFFFile)
